...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $salary = $_POST['salary'];
            ...
            $insert_query = "INSERT INTO `contacts` (`sno`, `name`, `email`, `salary`, `date`) VALUES ('2', '$name', '$email', '$salary', current_timestamp());";
    ...
    <div class="container p-5">
        <h1>Registration</h1>
        <form method="post" action="/learn-php/form_database.php">
            <div class="mb-3">
